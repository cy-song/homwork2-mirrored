...
imgList = dir('C:\Users\jenny\Downloads\CV\homework2-master/homework2-master/data/uttower*.jpg');

saveFileName = 'uttower.jpg';
...
for i = 1 : length(imgList),
    IMAGES{i} = imread(['C:\Users\jenny\Downloads\CV\homework2-master\homework2-master/data/' imgList(i).name]);
